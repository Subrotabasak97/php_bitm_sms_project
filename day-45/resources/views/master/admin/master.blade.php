...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | BITM - Responsive Bootstrap 4 Admin Dashboard</title>
    ...
    <div class="main-content">
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © BITM.
                    </div>
                    <div class="col-sm-6">
                        <div class="text-sm-right d-none d-sm-block">
                            Design & Develop by Subrota Basak
                        </div>
                    </div>
                </div>
            </div>
